...
_G.packer_plugins = {
  ...
  ["cmp-dap"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/cmp-dap",
  ...
  ["iron.nvim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/iron.nvim",
  ...
  neogit = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["vim-moonfly-colors"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-moonfly-colors",
    url = "https://github.com/bluz71/vim-moonfly-colors"
  },
  ["vim-nightfly-colors"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-nightfly-colors",
